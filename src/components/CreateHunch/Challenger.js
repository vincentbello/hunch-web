...
export default function Challenger({ valid }: StepProps) {
  ...
  return (
    <Container>
      ...
      <Content full={valid}>
        <FriendSelect autoFocus contained large value={creationState.bettee} selectUser={(user: User) => dispatch(setBettee(user))} />
